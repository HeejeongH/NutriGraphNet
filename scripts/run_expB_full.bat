...
python src\nutrigraphnet_v2.py --variants full --lambda_health 0.01 --interaction_ratio 0.1 --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/B_full_10pct
echo   Done density=10%%

echo.
echo [2/5] EXP-B: NutriGraphNet at 30%% interaction density
python src\nutrigraphnet_v2.py --variants full --lambda_health 0.01 --interaction_ratio 0.3 --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/B_full_30pct
echo   Done density=30%%

echo.
echo [3/5] EXP-B: NutriGraphNet at 50%% interaction density
python src\nutrigraphnet_v2.py --variants full --lambda_health 0.01 --interaction_ratio 0.5 --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/B_full_50pct
echo   Done density=50%%

echo.
echo [4/5] EXP-B: NutriGraphNet at 70%% interaction density
python src\nutrigraphnet_v2.py --variants full --lambda_health 0.01 --interaction_ratio 0.7 --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/B_full_70pct
echo   Done density=70%%

echo.
echo [5/5] EXP-B: NutriGraphNet at 100%% interaction density (reproducibility check)
python src\nutrigraphnet_v2.py --variants full --lambda_health 0.01 --interaction_ratio 1.0 --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/B_full_100pct
