...
python src\nutrigraphnet_v2.py --variants full --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/F_ablation_full_graph
echo   Done: full_graph

python src\nutrigraphnet_v2.py --variants full --ablate_no_ingredient --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/F_ablation_no_ingredient
echo   Done: no_ingredient

python src\nutrigraphnet_v2.py --variants full --ablate_no_time --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/F_ablation_no_time
echo   Done: no_time

python src\nutrigraphnet_v2.py --variants full --ablate_no_healthness --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/F_ablation_no_healthness
echo   Done: no_healthness

python src\nutrigraphnet_v2.py --variants full --ablate_no_food_similar --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/F_ablation_no_food_similar
echo   Done: no_food_similar

python src\nutrigraphnet_v2.py --variants full --ablate_no_ingredient --ablate_no_time --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/F_ablation_no_ingredient_time
echo   Done: no_ingredient_time

python src\nutrigraphnet_v2.py --variants full --ablate_no_ingredient --ablate_no_time --ablate_no_food_similar --n_folds 5 --epochs 300 --patience 30 --hidden_channels 128 --out_channels 64 --num_layers 3 --heads 4 --seed 42 --output_dir results/gpu/F_ablation_no_all_auxiliary
