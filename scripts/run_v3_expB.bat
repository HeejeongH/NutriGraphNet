...
python src\nutrigraphnet_v3.py --data data/processed_data/processed_data_GNN_v5.pkl --output results/v3_expB_10pct --folds 5 --epochs 300 --hidden 128 --out_dim 64 --layers 3 --heads 4 --dropout 0.2 --lr 1e-3 --lambda_health 0.005 --phase1_frac 0.8 --infonce_weight 0.1 --batch_size 4096 --device auto --seed 42 --interaction_ratio 0.1
echo   Done density=10%%

echo.
echo [2/2] v3 at 30%% interaction density
python src\nutrigraphnet_v3.py --data data/processed_data/processed_data_GNN_v5.pkl --output results/v3_expB_30pct --folds 5 --epochs 300 --hidden 128 --out_dim 64 --layers 3 --heads 4 --dropout 0.2 --lr 1e-3 --lambda_health 0.005 --phase1_frac 0.8 --infonce_weight 0.1 --batch_size 4096 --device auto --seed 42 --interaction_ratio 0.3
