...
python src\nutrigraphnet_v3.py --data data/processed_data/processed_data_GNN_v5.pkl --output results/v3_e300_lr3e4 --folds 5 --epochs 300 --hidden 128 --out_dim 64 --layers 3 --heads 4 --dropout 0.2 --lr 3e-4 --lambda_health 0.005 --phase1_frac 0.8 --infonce_weight 0.1 --batch_size 4096 --device auto --seed 42
echo   Done: epochs=300, lr=3e-4

echo.
echo [2/2] v3 fully matched to v2: epochs=300, lr=1e-3
python src\nutrigraphnet_v3.py --data data/processed_data/processed_data_GNN_v5.pkl --output results/v3_e300_lr1e3 --folds 5 --epochs 300 --hidden 128 --out_dim 64 --layers 3 --heads 4 --dropout 0.2 --lr 1e-3 --lambda_health 0.005 --phase1_frac 0.8 --infonce_weight 0.1 --batch_size 4096 --device auto --seed 42
